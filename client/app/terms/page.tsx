      ...
      <div className="max-w-3xl mx-auto bg-white/90 backdrop-blur-md rounded-3xl border border-[var(--border-light)] p-10 md:p-14 shadow-sm">
        ...
        <div className="space-y-8 text-[var(--text-muted)] font-medium leading-relaxed">
          ...
          <section>
            ...
            <p>
              By accessing our website and purchasing products from DSE Originals, you agree to be bound by these Terms of Service. If you do not agree with any part of these terms, you are prohibited from utilizing our services.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="bg-[var(--brand-soft)]/20 p-4 rounded-xl border border-[var(--brand-accent)]/20 font-semibold text-[var(--brand-primary)]">
              <strong>Strictly No Cash on Delivery (COD) and No Refunds.</strong> Every purchase made through DSE Originals requires upfront digital payment. We do not support COD under any circumstances. Furthermore, to maintain our premium quality control, all sales are considered final and strict, and we do not issue refunds.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              All content on this store, including typography, designs, product images, and branding, is the exclusive intellectual property of DSE Originals. Copying or modifying our assets without authorization is strictly prohibited.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              These Terms of Service are governed by and construed in accordance with local regulations. Any disputes shall be resolved in the jurisdiction where DSE Originals operates.
            </p>
          </section>
