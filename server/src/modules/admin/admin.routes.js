...
router.get("/review-requests", authorize("admin", "staff"), adminController.getReviewRequests)
router.post("/review-requests/send", authorize("admin", "staff"), adminController.sendReviewRequests)
